...
const GenerateImages = () => {
    const ImageStyle = [
        'Realistic', 'Ghibli style', 'Anime style', 'Cartoon style', 'Fantasy style', 'Realistic style', '3D style', 'Finance', 'Portrait style'
    ]
    ...
    const onSubmitHandler = async (e) => {
        e.preventDefault()
        // Handle article generation logic here
    }
    return (
        <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
            ...
            <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
                <div className='flex items-center gap-3'>
                    ...
                    <h1 className='tex-xl font-semibold'>AI Image Generator</h1>
            ...
            {/* right col */}
            <div className='w-full flex flex-col max-w-lg p-4 bg-white rounded-lg border border-gray-200 min-h-96 '>
                <div className='flex items-center gap-3'>
