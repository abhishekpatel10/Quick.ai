    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
            <div className='text-center mb-6'>
                ...
                <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs texxt-gray-600'>Transform your content creation with our suite of premium AI tools.
            ...
            <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
                ...
                <button onClick={() => navigate('/demo')} className='bg-white px-10 py-3 rounded-lg border border-gray-300 hover:scale-102 active:scale-95 transition cursor-pointer'> Watch Demo</button>
            </div>
